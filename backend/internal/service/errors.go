...
var (
	...
	ErrRefundExceeded      = errors.New("service: cumulative refund amount exceeds paid amount")
	ErrDuplicateVoucher    = errors.New("service: refund voucher no already registered")
)
